    ...
    <div className="min-h-screen bg-background flex">
      <div className="hidden lg:flex lg:w-1/2 bg-sidebar items-center justify-center p-12">
        <div className="max-w-md">
          <h1 className="text-4xl font-display font-bold mb-4">
            ...
            <span className="text-sidebar-primary-foreground">CRM</span>
          </h1>
          <p className="text-sidebar-foreground text-lg leading-relaxed">
            Start managing your customer relationships with a powerful, modern CRM.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          <p className="text-sm text-muted-foreground mb-8">Get started with NovaCRM</p>
